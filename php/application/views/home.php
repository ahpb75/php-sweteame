...
<head>
    ...
    <title>Online TA/PLA Application Form</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="#page-top">Team E | TA/PLA Web Application</a>
        </div>
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="../../bootstrap/img/mu_logo.png" alt="" height="300" width="300">
...
<footer class="text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="footer-col col-md-4">
                    <h3>Location</h3>
                    <p>244 Engineering Building West
                        Columbia, MO 65211</p>
                </div>
                <div class="footer-col col-md-4">
    ...
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    Copyright &copy; TA/PLA Application Form 2015
                </div>
            </div>
        </div>
    </div>
